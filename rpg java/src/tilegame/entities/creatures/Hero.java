...
public class Hero extends Creature {
    ...
    public static float SPEEDhero = 3;
    ...
    private void checkskill() {
    		if(handler.getKeyManager().swapskill) {
    			if(weapons == 1) weapons = 0;
    			else weapons = 1;
    		}
    }
        ...
        if (mana > 0) {
            ...
            if (handler.getKeyManager().skillShot) {
                ...
                if (dir == CreatureDir.up) {
                    ...
                    handler.getWorldManager().getWorld().getEntityManager().addEntity(new Kamezoko(handler, skillX, skillY, dir,weapons));
                } else if (dir == CreatureDir.down) {
                    int skillX = (int) x;
                ...
                mana -= Kamezoko.DEFAULT_COST + weapons*5;
                attackTimer = 0;
